...
var star,star_img;
var star2,star_2img;
var emptystar_img, onestar_img, twostar_img;
var g_star;
...
function preload()
{
  ...
  onestar_img = loadImage("star.png");
  twostar_img = loadImage("stars.png");
  emptystar_img = loadImage("empty.png");
...
function setup() 
{
  ...
  airBlower.position(270,350);
  airBlower.size(60,60);
  airBlower.mouseClicked(blow);

  star = createSprite(320,50,20,20);
  star.addImage(g_star);
  star.scale = 0.05;
  star.addAnimation("star1",onestar_img);

  star2 = createSprite(50,330,20,20);
  star2.addImage(g_star);
  star2.scale = 0.05;
  star2.addAnimation("star1",onestar_img);
...
function draw() 
{
  ...
  {
    star.changeAnimation(star1);
  }
  if(collide(fruit,star2,40)==true)
  {
    star2.changeAnimation(star1);
  }
